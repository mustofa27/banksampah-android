...
import com.mustofa27.banksampah.databinding.ActivityNewsBinding;
...
import com.mustofa27.banksampah.viewmodel.NewsViewModel;
...
public class NewsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)getSupportActionBar().getCustomView().findViewById(R.id.title)).setText("Berita Terkini");
        ...
        adapter = new GenericRecyclerAdapter(newsClasses, R.layout.news_list_item, new AdapterCallback() {
            ...
            public void bindView(View view, Object object) {
                ...
                author.setText(current.getAuthor() != null ? current.getAuthor().getName() : "Admin");
                ...
                Glide.with(NewsActivity.this)
                        .load(ConnectionHandler.IMAGE_URL + current.getPath_image())
